...
<meta name="description" content="I publish claims about AI systems and then try to prove them wrong. Ten of the last twelve did not survive contact with their own measurements.">
...
<meta property="og:description" content="I publish claims about AI systems and then try to prove them wrong. Ten of the last twelve did not survive contact with their own measurements.">
...
<section class="section" id="register">
  <div class="section__head">
    ...
    <span class="label">{total} claims · {revised} revised by their own evidence</span>
  </div>
  <p class="section__note">
    ...
    then rewritten to whatever came back. Open a row to see what was predicted and
    what happened.
  </p>
